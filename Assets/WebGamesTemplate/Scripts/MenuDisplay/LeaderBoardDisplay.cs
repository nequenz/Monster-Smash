...
public class LeaderBoardDisplay : MonoBehaviour
{
    ...
    {
        DungeonGames.VKGames.Leaderboard.ShowLeaderboard(_playerScore);
    }
    ...
    public void OpenYandexLeaderboard()
    {
        ...
        Agava.YandexGames.Leaderboard.GetEntries(_leaderboardName, (result) =>
        {
    ...
    public void SetLeaderboardScore()
    {
        ...
        {
            Agava.YandexGames.Leaderboard.GetPlayerEntry(_leaderboardName, OnSuccessCallback);
        }
    }
    ...
    private void OnSuccessCallback(LeaderboardEntryResponse result)
    {
        ...
        {
            Agava.YandexGames.Leaderboard.SetScore(_leaderboardName, _playerScore);
        }      
    }
}
